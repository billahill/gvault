...
public class RolesListForm {
    ...
    public Form createRolesListFrom() {
        final Form form = new Form();
        form.setCaption("Roles List ");
        form.setImmediate(false);
        form.setFormFieldFactory(new RolesListFieldFactory());
    ...
    static class RolesListFieldFactory extends DefaultFieldFactory {
