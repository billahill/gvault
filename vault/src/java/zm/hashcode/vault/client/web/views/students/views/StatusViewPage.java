...
import zm.hashcode.vault.client.web.views.students.forms.StatusForm;
import zm.hashcode.vault.client.web.views.students.model.StatusBean;
import zm.hashcode.vault.client.web.views.students.tables.StatusTable;
   ...
   // private final StatusFactory factory = data.getStatusFactory();
    ...
    public void buttonClick(ClickEvent event) {
        ...
        if (source == pform.getSave()) {
            saveNewStatus(form);
            main.mainView.setSecondComponent(new StudentsMenuView(main, "STATUS"));
